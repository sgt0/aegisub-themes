...
import { MOUNTAIN_THEME } from './mountain';
import { POPPO_THEME } from './poppo';
import { SAKURA_THEME } from './sakura';
import { SETI_THEME } from './seti';
import { SOLARIZED_DARK_THEME } from './solarized-dark';
import { SOLARIZED_LIGHT_THEME } from './solarized-light';
import { ZENBURN_THEME } from './zenburn';
